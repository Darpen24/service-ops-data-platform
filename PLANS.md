...
| 2 | PostgreSQL and SQL | Schemas, idempotent loading, audit, analytical SQL and integration tests | SQL, transactions, warehouse design | In review; Docker validation required |
